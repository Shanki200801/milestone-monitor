...
export default function Socials() {
  const [settings, setSettings] = useState<Socials>({
  ...
  return (
    <div
      id="socials-wrapper"
      className="text-teal-950 flex flex-col p-4 bg-teal-500/20 col-start-1 row-start-2 border border-transparent rounded md:mt-[2vh] h-fit"
    >
      <h2 className="text-center font-bold uppercase lg:text-2xl">
        SOCIAL LINKS
      </h2>
      <div className="flex flex-col justify-center gap-4 p-4 w-full border border-transparent rounded">
