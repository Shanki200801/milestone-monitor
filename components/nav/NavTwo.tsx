      ...
      >
        ...
        <li className="hover:text-emerald-300 ">
          <a href="/">
            ...
            <p className="tracking-tight uppercase">Dashboard</p>
          </a>
        </li>
        <li className="hover:text-emerald-300 ">
          <a href="/my-workshops">
            ...
            <p className="tracking-tight uppercase">Workshops</p>
          </a>
        </li>
        <li className="hover:text-emerald-300 ">
          <a href="/my-conferences">
            ...
            <p className="tracking-tight uppercase">Conferences</p>
          </a>
        </li>
        <li className="hover:text-emerald-300 ">
          <a href="/my-journals">
            ...
            <p className="tracking-tight uppercase">Journals</p>
          </a>
        </li>
        <li className="hover:text-emerald-300 ">
          <a href="/my-patents">
            ...
            <p className="tracking-tight uppercase">Patents</p>
          </a>
        </li>
      </ul>
    </section>
