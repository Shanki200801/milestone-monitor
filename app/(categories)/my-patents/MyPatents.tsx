...
const FormElements=(props:any)=>{
  ...
  const handlePatentUpdate = async ()=>{
    await updatePatents(patentName, patentDate, patentType, applicationNo, status, patentLink, props.data.is_verified, props.data.id);
        ...
        <Modal.Body>
          <div className="space-y-6">
            ...
            <div>
              ...
              <TextInput  type="text" onChange={(e) => setPatentName(e.target.value)} value={patentName} required />
            </div>
            <div>
              <div className="mb-2 block">
                <Label  value="Patent Type" />
              </div>
              <TextInput  type="text" onChange={(e) => setPatentType(e.target.value)} value={patentType} required />
            </div>
            <div>
              <div className="mb-2 block">
                <Label  value="Application Number" />
              </div>
              <TextInput type="text" onChange={(e) => setApplicationNo(e.target.value)} value={applicationNo} required />
            </div>
            <div>
              <div className="mb-2 block">
                <Label  value="Status" />
              </div>
              <TextInput  type="text" onChange={(e) => setStatus(e.target.value)} value={status} required />
            </div>
            <div>
              <div className="mb-2 block">
            ...
            <div>
              ...
              <TextInput  type="date" onChange={(e) => setPatentDate(e.target.value)} value={patentDate} required />
            </div>
