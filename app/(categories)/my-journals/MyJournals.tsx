...
const FormElements=(props:any)=>{
  ...
  const handleConfUpdate = async ()=>{
    await updateJournals(paperTitle, date, journalName, issn, indexedIn, link, props.data.is_verified, props.data.id);
        ...
        <Modal.Body>
          <div className="space-y-6">
            ...
            <div>
              ...
              <TextInput id="paper_title" type="text" onChange={(e) => setPaperTitle(e.target.value)} value={paperTitle} required />
            </div>
            <div>
              <div className="mb-2 block">
                <Label htmlFor="conf_name" value="Journal Name" />
              </div>
              <TextInput id="conf_name" type="text" onChange={(e) => setJournalName(e.target.value)} value={journalName} required />
            </div>
            <div>
              <div className="mb-2 block">
            ...
            <div>
              ...
              <TextInput id="conf_type" type="text" onChange={(e) => setIssn(e.target.value)} value={issn} required />
            </div>
            <div>
              <div className="mb-2 block">
                <Label  value="Indexed In" />
              </div>
              <TextInput type="text" onChange={(e) => setIndexedIn(e.target.value)} value={indexedIn} required />
            </div>
            <div>
              <div className="mb-2 block">
                <Label htmlFor="cert" value="Link" />
              </div>
              <TextInput id="cert" type="text" onChange={(e) => setLink(e.target.value)} value={link} required />
            </div>
